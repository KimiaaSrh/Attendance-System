...
import ir.ac.shirazu.attendance_system.Activity.HapticFeedbackController;
import ir.ac.shirazu.attendance_system.R;
import ir.ac.shirazu.attendance_system.Activity.TypefaceHelper;
import ir.ac.shirazu.attendance_system.Activity.Utils;
import ir.ac.shirazu.attendance_system.Activity.CalendarUtils.LanguageUtils;
...
public class DatePickerDialog extends DialogFragment implements OnClickListener, DatePickerController {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mMonthAndDayView = (LinearLayout) view.findViewById(R.id.date_picker_month_annd_day);
...
//        } TODO
    ...
    public void onClick(View v) {
        ...
        } else if (v.getId() == R.id.date_picker_month_annd_day) {
